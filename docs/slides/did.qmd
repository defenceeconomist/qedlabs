...
## Three paired R and Python labs
...
[Lab setup and verified outputs](../labs/difference-in-differences-reproducibility.qmd) · [Reading map](../notes/did/difference-in-differences-sources.qmd)
...
## Appendix: R and Python implementations

| Method | R | Python |
|---|---|---|
| Four-cell regression | `lm` | `statsmodels` |
| Fixed effects | `fixest` | `pyfixest` |
| Cohort-aware event study | `sunab` | `event_study` saturated |
| Group-time effects | `did` | `differences` |
| Decomposition / sensitivity | `bacondecomp` / `HonestDiD` | R extensions |

See the lab setup page for pinned versions and inference differences.
