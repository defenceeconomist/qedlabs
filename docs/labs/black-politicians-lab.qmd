...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/black-politicians-lab.qmd){download="black-politicians-lab.qmd"}
[R Jupyter notebook](notebooks/black-politicians-lab.ipynb){download="black-politicians-lab.ipynb"}
[Complete lab ZIP](downloads/black-politicians-lab.zip){download="black-politicians-lab.zip"}
[Data and setup](data.qmd#black-politicians-lab)
:::
<!-- lab-downloads:end -->
