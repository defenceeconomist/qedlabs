...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/nsw-cps-benchmark-lab.qmd){download="nsw-cps-benchmark-lab.qmd"}
[R Jupyter notebook](notebooks/nsw-cps-benchmark-lab.ipynb){download="nsw-cps-benchmark-lab.ipynb"}
[Complete lab ZIP](downloads/nsw-cps-benchmark-lab.zip){download="nsw-cps-benchmark-lab.zip"}
[Data and setup](data.qmd#nsw-cps-benchmark-lab)
:::
<!-- lab-downloads:end -->
