...
references:
- DOI: 10.2307/2981553
  URL: https://doi.org/10.2307/2981553
  author:
  - family: Harvey
    given: Andrew C.
  - family: Durbin
  ...
  id: harvey1986seatbelts
  issue: '3'
  issued:
    date-parts:
    - - 1986
  page: 187-227
  title: 'The effects of seat belt legislation on british road casualties: A case
    study in structural time series modelling'
  title-short: The effects of seat belt legislation on british road casualties
  type: article-journal
  volume: '149'
- URL: https://researchbriefings.files.parliament.uk/documents/SN00043/SN00043.pdf
  accessed:
    date-parts:
    - - 2026
      - 8
      - 4
  author:
  - literal: House of Commons Library
  id: ukparliament2012seatbelts
  issued:
    date-parts:
    - - 2012
  publisher: House of Commons Library Standard Note SN/BT/43
  title: 'Motor vehicles: Seat belts and child restraints'
  title-short: Motor vehicles
  type: ''
---
...
Continue to [Seatbelt Law Design and Robustness](https://defenceeconomist.github.io/qedlabs/labs/interrupted-time-series-design-diagnostics-lab.html) to compare outcomes, candidate controls, and a compact prespecified sensitivity set.
