...
- URL: https://theeffectbook.net/ch-DifferenceinDifference.html
  ...
  - family: Huntington-Klein
    given: Nick
  container-title: 'The effect: An introduction to research design and causality'
  id: huntingtonklein2021did
  issued:
    date-parts:
    - - 2021
...
- DOI: 10.1596/978-1-4648-0779-4
  ...
  - family: Vermeersch
    given: Christel M. J.
  container-title: Impact evaluation in practice
  edition: '2'
  id: gertler2016ch7did
  issued:
    date-parts:
    - - 2016
  ...
  title-short: Chapter 7
  type: chapter
- URL: https://evalsp26.classes.andrewheiss.com/example/diff-in-diff.html
  accessed:
    date-parts:
    - - 2026
      - 8
  ...
  - family: Heiss
    given: Andrew
  id: heiss2026didexample
  issued:
    date-parts:
    - - 2026
  note: Program Evaluation code example
  title: 'Difference-in-differences: Worked example'
  title-short: Difference-in-differences
  type: webpage
- URL: https://www.jstor.org/stable/2118178
  author:
  - family: Meyer
    given: Bruce D.
  - family: Viscusi
  ...
  title-short: Workers’ compensation and injury duration
...
The workflow draws on Gertler et al.'s counterfactual framing, Huntington-Klein's design-first treatment, and Andrew Heiss's worked example [@gertler2016ch7did; @huntingtonklein2021did; @heiss2026didexample]. See the [DiD overview](https://defenceeconomist.github.io/qedlabs/notes/did/difference-in-differences.html) and [Heiss source notes](https://defenceeconomist.github.io/qedlabs/notes/did/andrew-heiss-difference-in-differences-notes.html) for the underlying reading.
