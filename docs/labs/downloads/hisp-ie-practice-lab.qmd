...
The CSV, Stata file, and original replication script are available on the [lab data page](https://defenceeconomist.github.io/qedlabs/labs/data.html#hisp). No external data folder or internet connection is needed to run the worksheet.
...
For a dedicated explanation of the four-cell contrast, parallel trends, and log-outcome interpretation, complete the [DiD foundations lab](https://defenceeconomist.github.io/qedlabs/labs/difference-in-differences-foundations-lab.html) first. The HISP branch remains a compact application inside this multi-method replication.
