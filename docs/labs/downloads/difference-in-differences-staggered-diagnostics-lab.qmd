...
execute:
  ...
  error: false
references:
- URL: https://mixtape-1ed.netlify.app/09-difference_in_differences
  accessed:
    date-parts:
    - - 2026
      - 8
  ...
  - family: Cunningham
    given: Scott
  container-title: 'Causal inference: The mixtape'
  id: cunningham2021did
  issued:
    date-parts:
    - - 2021
...
- DOI: 10.3368/jhr.48.3.821
  URL: https://doi.org/10.3368/jhr.48.3.821
  author:
  - family: Cheng
    given: Cheng
  - family: Hoekstra
    given: Mark
  container-title: Journal of Human Resources
  id: cheng2013castle
  issue: '3'
  issued:
    date-parts:
    - - 2013
  page: 821-854
  title: Does strengthening self-defense law deter crime or escalate violence? Evidence
    from expansions to castle doctrine
...
- DOI: 10.1257/aeri.20210236
  ...
  - family: Roth
    given: Jonathan
  container-title: 'American Economic Review: Insights'
  id: roth2022pretest
  issue: '3'
  issued:
    date-parts:
  ...
  title-short: Pretest with caution
  type: article-journal
  volume: '4'
---
...
The case comes from Cunningham's castle-doctrine example [@cunningham2021did; @cheng2013castle]. The interpretation follows Goodman-Bacon and Sun–Abraham [@goodmanbacon2021timing; @sunabraham2021dynamic]. See the [Mixtape notes](https://defenceeconomist.github.io/qedlabs/notes/did/mixtape-difference-in-differences-notes.html), [Goodman-Bacon notes](https://defenceeconomist.github.io/qedlabs/notes/did/goodman-bacon-treatment-timing-notes.html), and [Sun–Abraham notes](https://defenceeconomist.github.io/qedlabs/notes/did/sun-abraham-event-studies-notes.html).
