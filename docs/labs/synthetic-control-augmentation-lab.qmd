...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/synthetic-control-augmentation-lab.qmd){download="synthetic-control-augmentation-lab.qmd"}
[R Jupyter notebook](notebooks/synthetic-control-augmentation-lab.ipynb){download="synthetic-control-augmentation-lab.ipynb"}
[Complete lab ZIP](downloads/synthetic-control-augmentation-lab.zip){download="synthetic-control-augmentation-lab.zip"}
[Data and setup](data.qmd#synthetic-control-augmentation-lab)
:::
<!-- lab-downloads:end -->
