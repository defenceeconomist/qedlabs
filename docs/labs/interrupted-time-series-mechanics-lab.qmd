...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/interrupted-time-series-mechanics-lab.qmd){download="interrupted-time-series-mechanics-lab.qmd"}
[R Jupyter notebook](notebooks/interrupted-time-series-mechanics-lab.ipynb){download="interrupted-time-series-mechanics-lab.ipynb"}
[Complete lab ZIP](downloads/interrupted-time-series-mechanics-lab.zip){download="interrupted-time-series-mechanics-lab.zip"}
[Data and setup](data.qmd#interrupted-time-series-mechanics-lab)
:::
<!-- lab-downloads:end -->
