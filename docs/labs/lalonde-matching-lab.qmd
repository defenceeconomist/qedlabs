...
- Keep the [Matching Report Draft](../reports/matching-report.qmd) open in another tab.
...
- read the [Matching Report Draft](../reports/matching-report.qmd) for the long-form scaffold
- review the [Matching and Weighting](../notes/matching-and-weighting.qmd) note for the method overview
