...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/lalonde-matching-lab.qmd){download="lalonde-matching-lab.qmd"}
[R Jupyter notebook](notebooks/lalonde-matching-lab.ipynb){download="lalonde-matching-lab.ipynb"}
[Complete lab ZIP](downloads/lalonde-matching-lab.zip){download="lalonde-matching-lab.zip"}
[Data and setup](data.qmd#lalonde-matching-lab)
:::
<!-- lab-downloads:end -->
