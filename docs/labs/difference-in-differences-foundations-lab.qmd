...
[Python companion](difference-in-differences-foundations-python-lab.qmd) · [Tested environment and reproduction record](difference-in-differences-reproducibility.qmd)
...
```{r}
required_packages <- c(
  "digest","wooldridge", "dplyr", "ggplot2", "fixest")
