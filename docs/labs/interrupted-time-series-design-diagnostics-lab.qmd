...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/interrupted-time-series-design-diagnostics-lab.qmd){download="interrupted-time-series-design-diagnostics-lab.qmd"}
[R Jupyter notebook](notebooks/interrupted-time-series-design-diagnostics-lab.ipynb){download="interrupted-time-series-design-diagnostics-lab.ipynb"}
[Complete lab ZIP](downloads/interrupted-time-series-design-diagnostics-lab.zip){download="interrupted-time-series-design-diagnostics-lab.zip"}
[Data and setup](data.qmd#interrupted-time-series-design-diagnostics-lab)
:::
<!-- lab-downloads:end -->
...
Continue to [Interrupted Time Series Counterfactual Validation](interrupted-time-series-counterfactual-validation-lab.qmd) to choose an untreated forecasting model without using post-intervention outcomes.
