...
aliases:
  - /labs/difference-in-differences-staggered-diagnostics-python-lab.html
format:
  html: default
execute:
  echo: true
...
<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/difference-in-differences-staggered-diagnostics-lab.qmd){download="difference-in-differences-staggered-diagnostics-lab.qmd"}
[R Jupyter notebook](notebooks/difference-in-differences-staggered-diagnostics-lab.ipynb){download="difference-in-differences-staggered-diagnostics-lab.ipynb"}
[Complete lab ZIP](downloads/difference-in-differences-staggered-diagnostics-lab.zip){download="difference-in-differences-staggered-diagnostics-lab.zip"}
[Data and setup](data.qmd#difference-in-differences-staggered-diagnostics-lab)
:::
<!-- lab-downloads:end -->
