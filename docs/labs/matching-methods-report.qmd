...
Its conceptual anchor is the repo's note on [*The Effect*: Matching](../notes/matching/effectbook-matching-notes.qmd), especially the chapter's emphasis that many matching procedures are easiest to understand as weighting designs.
...
2. Read the [*The Effect* notes](../notes/matching/effectbook-matching-notes.qmd) for the weighting-first conceptual frame.
