...
notebook-language: r
aliases:
  - /labs/regression-discontinuity-fuzzy-python-lab.html
format:
  html: default
execute:
  echo: true
...
Allow 60–90 minutes. You should be comfortable with basic regression and R data frames. Restore the [tested environment](regression-discontinuity-reproducibility.qmd), then run every cell in order in a fresh kernel. Every run loads and verifies the bundled local data. No data are downloaded. The HTML page displays code; the downloadable notebook executes it.

<!-- lab-downloads:start -->
::: {.resource-links}
[Quarto document](downloads/regression-discontinuity-fuzzy-lab.qmd){download="regression-discontinuity-fuzzy-lab.qmd"}
[R Jupyter notebook](notebooks/regression-discontinuity-fuzzy-lab.ipynb){download="regression-discontinuity-fuzzy-lab.ipynb"}
[Complete lab ZIP](downloads/regression-discontinuity-fuzzy-lab.zip){download="regression-discontinuity-fuzzy-lab.zip"}
[Data and setup](data.qmd#regression-discontinuity-fuzzy-lab)
:::
<!-- lab-downloads:end -->
